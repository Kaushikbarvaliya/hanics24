                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        ...
                        <h4 wire:loading.remove wire:target="totalDataCount" class="fs-22 fw-semibold ff-secondary mb-4">
                            <!--[if BLOCK]><![endif]--><?php if(!empty($totalDataCount) && $totalDataCount['device_alerts'] != ""): ?>
                                <span class="counter-value" data-target="<?php echo e($totalDataCount['device_alerts']); ?>">0</span>
                            <?php else: ?>
                                <span>N/A</span>
...
</div> <!-- end row--><?php /**PATH D:\XAMPP\htdocs\hanics24\resources\views/livewire/dashboard.blade.php ENDPATH**/ ?>